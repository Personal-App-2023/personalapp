  ...
  steps {
   ...
   stage('Check code coverage') {
      ...
      steps {
          ...
          sh 'docker build -t doaafarouk/personal:${VERSION} .'
          sh 'docker push doaafarouk/personal:${VERSION}'
      }
    }
    ...
    stage('Update Image Tag in GitOps') {
      steps {
        ...
        script {
       sh '''
          sed -i "s/image:.*/image: doaafarouk\\/personal:${VERSION}/" personal-manifest.yml
        '''
